...
function Main
{
    ...
    Write-Host "Converting .navjson to .nav..."
    Convert-NavJson-To-Nav
    
    Write-Host "Compiling QuakeC Rogue version..."
    Compile-QuakeC "-DROGUE"
    
    Add-To-Pak @("progs.dat")
    
    Build-Pak "pak_rogue.pak"
    ...
    Build-Pak "pak_rogue.pak"
    Add-To-Zip @($folder_pak,"pak_rogue.pak") @("rogue","pak1.pak") #rogue
    ...
    Add-To-Zip @($folder_pak,"pak_id1.pak") @("id1","pak0.pak") #id1
    Add-To-Zip @($folder_pak,"pak_id1.pak") @("mg1","pak1.pak") #mg1
    Add-To-Zip "README.md"
    Add-To-Zip "Install Mod Links.bat"
